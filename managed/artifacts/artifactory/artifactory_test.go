...
import (
	...
	art "github.com/jbrette/kubext/managed/artifacts/artifactory"
	"github.com/stretchr/testify/assert"
)

const (
	LoadFileName string = "kubext_artifactory_test_load.txt"
	SaveFileName string = "kubext_artifactory_test_save.txt"
