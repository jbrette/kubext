...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedStep) DeepCopyInto(out *ManagedStep) {
	*out = *in
	in.Arguments.DeepCopyInto(&out.Arguments)
	if in.WithItems != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedStep.
func (in *ManagedStep) DeepCopy() *ManagedStep {
	if in == nil {
		return nil
	}
	out := new(ManagedStep)
