...
def main():
    parser = argparse.ArgumentParser(description='Visualize graph of a managed')
    parser.add_argument('managed', type=str, help='managed name')
    args = parser.parse_args()
    res = run(["kubectl", "get", "managed", "-o", "json", args.managed  ], stdout=subprocess.PIPE)
